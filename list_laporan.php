	...
	<div class="container-fluid-full">
		...
		<div id="content" class="span10">
			<ul class="breadcrumb">
				...
				<li><a href="list_report.php">Laporan</a></li>
			</ul>
						  ...
						  ?>
							<tr>
								...
								?>
									...
									<a class="btn btn-danger" href="list_laporan.php?delete=<?php echo $data->id_laporan; ?>" onclick="return confirm('Are you sure?')">
										<i class="halflings-icon white trash"></i> 
									</a><?php } ?>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="center">
									<a class="btn btn-success" href="detail_laporan.php?id=<?php echo $dataAll->id_laporan; ?>">
										<i class="halflings-icon white zoom-in"></i>  
									</a>
									<a class="btn btn-danger" href="list_laporan.php?delete=<?php echo $dataAll->id_laporan; ?>" onclick="return confirm('Are you sure?')">
										<i class="halflings-icon white trash"></i> 
									</a>
								</td>
							</tr><?php	} } ?>
