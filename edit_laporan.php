...
<div class="container-fluid-full">
		<div class="row-fluid">
			...
			<?php 
				...
				$report_id = $_GET['id'];
				$data = $report->getID_laporan($report_id);
			?>
						...
						<form class="form-horizontal" method="POST">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="subject" value="<?php echo $data->subject; ?>" disabled="">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="textarea2"><?php echo tgl_indo(date('Y-m-d'));?></label>
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" name="laporan"><?php echo $data->content; ?></textarea>
							  </div>
							</div>
